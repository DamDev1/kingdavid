      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-3">
              <span className="text-sm tracking-wide uppercase text-gray-400">
                Offices
              </span>

              <div className="text-xs tracking-wide text-gray-400 flex flex-col mt-2">
                <span className="flex items-center gap-1.5"><MapIcon size={15} />Office 1: 122 Gordon commercial Dr ste A10. Lagrange GA 30240</span> <br />
                <span className="flex items-center gap-1.5"><MapIcon size={15} />Office 2: 113-06 Jamaica avenue Richmond Hill NY 11418</span>
              </div>
            </p>
